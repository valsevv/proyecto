...
class NetworkManager {
  ...
  _onMessage(event) {
    ...
    if (msg.type === "attackResult") {
      console.log(
        `[FRONTEND][RECEIVE] ⚔️ attackResult - Target=${msg.targetPlayer}/${msg.targetDrone} damage=${msg.damage} remainingHealth=${msg.remainingHealth} hit=${msg.hit}`
      );
      console.log(
        `[FRONTEND][RECEIVE] ⚔️ attackResult - Attacker=${msg.attackerPlayer}/${msg.attackerDrone} attackerHealth=${msg.attackerRemainingHealth} attackerDestroyed=${msg.attackerDestroyed}`
      );
    }
