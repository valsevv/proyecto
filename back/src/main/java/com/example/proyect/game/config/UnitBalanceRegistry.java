...
public final class UnitBalanceRegistry {
    ...
    public static final double DEFAULT_NAVAL_DRONE_ACCURACY = 0.75;
    ...
    private static volatile double navalDroneAccuracy = DEFAULT_NAVAL_DRONE_ACCURACY;
    ...
    public static void configure(
            ...
            double configuredNavalDroneAccuracy,
        ...
        navalDroneAccuracy = requirePercent(configuredNavalDroneAccuracy, "navalDroneAccuracy");
    ...
    private static double requirePercent(double value, String fieldName) {
    ...
    public static double getNavalDroneAccuracy() { return navalDroneAccuracy; }
